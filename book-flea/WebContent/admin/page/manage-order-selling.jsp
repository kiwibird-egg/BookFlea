...
<body>
	<main>
		...
		<div class="page-title">
			<a href="?sec=order">주문관리</a>&nbsp>&nbsp<a href="#"> 판매중인 도서</a>
		</div>
			...
			<%	
				...
				String sellerId = DAO.getSellingInfo(orderNo).getSellerId();
				String bookTitle = DAO.getSellingInfo(orderNo).getBookTitle();
				String bookCondition = DAO.getSellingInfo(orderNo).getBookCondition();
				int price = DAO.getSellingInfo(orderNo).getPrice();
